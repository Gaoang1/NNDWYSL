...
from backbone.oafpn import oafpn
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.FPN = oafpn(self.resnet50, 2, 6)
...
class RCNN(nn.Module):
    def __init__(self):
        ...
        self.bn1 = nn.GroupNorm(num_groups=64, num_channels=256)
        self.bn2 = nn.GroupNorm(num_groups=64, num_channels=256)
        self.bn3 = nn.GroupNorm(num_groups=64, num_channels=256)
        self.bn4 = nn.GroupNorm(num_groups=64, num_channels=256)
    ...
    def forward(self, fpn_fms, rcnn_rois, labels=None, bbox_targets=None):
        ...
        feature = F.relu_(self.bn1(self.conv1(pool_features)))   
        feature = F.relu_(self.bn2(self.conv2(feature)))
        feature = F.relu_(self.bn3(self.conv3(feature)))
        feature = F.relu_(self.bn4(self.conv4(feature)))
        flatten_feature = torch.flatten(feature, start_dim=1)  
        flatten_feature = F.relu_(self.fc(flatten_feature))
